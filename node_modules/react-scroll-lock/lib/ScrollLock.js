...
var WithScrollLock = function (_PureComponent) {
  _inherits(WithScrollLock, _PureComponent);

  function WithScrollLock() {
    var _ref;

    var _temp, _this, _ret;

    _classCallCheck(this, WithScrollLock);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = WithScrollLock.__proto__ || Object.getPrototypeOf(WithScrollLock)).call.apply(_ref, [this].concat(args))), _this), _this.onScrollHandler = function (e) {
    ...
    }, _this.lockElem = function (el) {
      return _this.element = el;
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(WithScrollLock, [{
